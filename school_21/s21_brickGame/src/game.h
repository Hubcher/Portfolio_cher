...
void print_rectangle(int top_y, int bottom_y, int left_x, int right_x); // Рисует прямоугольник на экране. Параметры задают координаты
void print_overlay(void);
void game_loop(void);
void stats_init(GameInfo_t *stats, curr_position_figure *curr_position);
UserAction_t get_signal(int user_input);
void execute_user_command_and_update_game_state(UserAction_t state, GameInfo_t *stats,
...
void rotate_middle_upper(curr_position_figure *curr_position);
